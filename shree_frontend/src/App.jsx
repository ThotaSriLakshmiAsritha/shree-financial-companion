...
import storyWomanPathsEn from './assets/story-woman-paths-en.png'
import storyWomanPathsHi from './assets/story-woman-paths-hi.png'
import storyWomanPathsTe from './assets/story-woman-paths-te.png'

const storyImages = {
  en: storyWomanPathsEn,
  hi: storyWomanPathsHi,
  te: storyWomanPathsTe,
}
import {
...
const translations = {
  te: {
    ...
    storyEyebrow: 'ఈరోజు చిన్న పాఠం', storyTitle: <>ఒక కథ విందామా? <span>🌾</span></>, storyCopy: 'ఒకసారి ఒక మహిళ కుట్టు మిషన్ కొనాలని అనుకుంది. ఆమె ముందు రెండు మార్గాలు ఉన్నాయి...', storyButton: 'కథ విందాం', storyAlt: 'రెండు మార్గాల ముందు నిలబడిన మహిళ - కథ చిత్రం', footerAlt: 'గ్రామీణ జీవితం చూపించే వర్లీ కళ', footerCopy: 'మీ ఆర్థిక ప్రయాణంలో మీతో',
  },
  hi: {
    ...
    storyEyebrow: 'आज की छोटी सीख', storyTitle: <>एक कहानी सुनें? <span>🌾</span></>, storyCopy: 'एक बार एक महिला सिलाई मशीन खरीदना चाहती थी। उसके सामने दो रास्ते थे...', storyButton: 'कहानी सुनें', storyAlt: 'दो रास्तों के सामने खड़ी महिला - कहानी का चित्र', footerAlt: 'गाँव का जीवन दिखाती वरली कला', footerCopy: 'आपकी आर्थिक यात्रा में आपके साथ',
  },
  en: {
    ...
    storyEyebrow: 'A small lesson for today', storyTitle: <>Shall we hear a story? <span>🌾</span></>, storyCopy: 'Once, a woman wanted to buy a sewing machine. She had two paths in front of her...', storyButton: 'Hear the story', storyAlt: 'Woman at crossroads deciding on a sewing machine - story illustration', footerAlt: 'Warli art showing village life', footerCopy: 'With you on your financial journey',
  },
}
